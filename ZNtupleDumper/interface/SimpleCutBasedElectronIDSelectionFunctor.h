...
class SimpleCutBasedElectronIDSelectionFunctor : public Selector<reco::GsfElectronRef>  {
 ...
 public: // interface  
  ...
  enum Version_t { NONE=0, fiducial, WP80PU, WP90PU, WP70PU, loose, medium, tight, loose25nsRun2, medium25nsRun2, tight25nsRun2, loose50nsRun2, medium50nsRun2, tight50nsRun2, tightElectronStream};
 ...
 SimpleCutBasedElectronIDSelectionFunctor(TString versionStr, 
  ...
  bool WPxx_PU( const reco::GsfElectronRef electronRef, pat::strbitset& ret)
  {
    ...
    Double_t sihih    = electron.sigmaIetaIeta(); //need to check if this one works
